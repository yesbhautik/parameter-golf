...
TRAIN_SCRIPT_DOMV3 = "records/track_10min_16mb/2026-03-21_DominationV3/train_gpt.py"
TRAIN_SCRIPT_DOMV4 = "records/track_10min_16mb/2026-03-21_DominationV4/train_gpt.py"
...
image = (
    ...
    .add_local_file(TRAIN_SCRIPT_DOMV3, "/root/train_gpt_domv3.py")
    .add_local_file(TRAIN_SCRIPT_DOMV4, "/root/train_gpt_domv4.py")
)
...
def _profile_env(mode: str, profile: str) -> dict[str, str]:
    ...
    if profile == "domv3":
        return {
            ...
            "EMA_DECAY": "0.997",
            "XSA_LAST_N": "4",
            "MIXED_QUANT_INT6_CATS": "mlp,attn,tok_emb",
            "WEIGHT_DECAY": "0.04",
            "MUON_WD": "0.04",
            "MATRIX_LR": "0.025",
            "SCALAR_LR": "0.025",
            ...
            "EVAL_STRIDE": "64",
            "EVAL_BATCH_SEQS": "32",
            "MAX_WALLCLOCK_SECONDS": "599.8",
            "FP16_PASSTHROUGH_PATTERNS": "",
            "STE_QAT_ENABLED": "0",
            "TTT_ENABLED": "0",
        }
...
def _select_train_script(profile: str, mode: str) -> str:
    if profile == "domv4":
        return "/root/train_gpt_domv4.py"
    return "/root/train_gpt_domv3.py"
